...
class MainWindow(QMainWindow):
    ...
    def __init__(self, connection, cursor, logged_user_id):
        ...
        self.media_player.setMedia(QMediaContent(QUrl.fromLocalFile("dashboard.mp3")))
    ...
    def create_tab_check_list_layout(self):
        ...
        image_label.setFixedSize(530, 400)
        pixmap = QPixmap('Passport.jpg')  # Replace with the actual path to your image
        image_label.setPixmap(pixmap)
        
        self.check_list_right_fourth_layout.addWidget(image_label, alignment=Qt.AlignCenter)
